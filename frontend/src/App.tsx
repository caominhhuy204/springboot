      ...
      <Routes>
        ...
        <Route element={<ProtectedRoute />}>
          <Route element={<AppShell />}>
            ...
            <Route
              path="/classrooms/:classroomId/pronunciation"
              element={<PronunciationExercisesPage />}
            />
            <Route
              path="/classrooms/:classroomId/pronunciation/:exerciseId"
              element={<PronunciationExerciseDetailPage />}
            />
          </Route>
        </Route>
